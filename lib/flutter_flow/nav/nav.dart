      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => SettingsPageWidget(
            idWall: params.getParam('idWall', ParamType.String),
          ),
        ),
        FFRoute(
          ...
          builder: (context, params) => PaymentConfirmedWidget(
            moneySent: params.getParam('moneySent', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'payment',
        ...
        FFRoute(
          name: 'confirmMail',
          path: '/confirmMail',
          builder: (context, params) => ConfirmMailWidget(
            moneySent: params.getParam('moneySent', ParamType.String),
          ),
        ),
        FFRoute(
          ...
          builder: (context, params) => AddCardWidget(
            ...
            number: params.getParam('number', ParamType.String),
        ...
        FFRoute(
          ...
          builder: (context, params) => TransactionsWidget(
            idWal: params.getParam('idWal', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'chartsPage',
          path: '/chartsPage',
          builder: (context, params) => ChartsPageWidget(
            idWal: params.getParam('idWal', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'newContact',
          path: '/newContact',
          builder: (context, params) => NewContactWidget(
            walletIdSetter: params.getParam('walletIdSetter', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'startPage',
